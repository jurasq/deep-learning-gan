...
class TripleGAN(object):
    ...
    def classifier(self, x, scope='classifier', is_training=True, reuse=False):
        with tf.variable_scope(scope, reuse=reuse):
            ...
            l1 = conv_layer(name_scope="convolutional_1", input_tensor=x, num_kernels=20, kernel_shape=[4, 9], relu=True, lrelu=True)
            ...
            l3 = conv_layer(name_scope="convolutional_2", input_tensor=l2, num_kernels=30, kernel_shape=[1, 5], relu=True, lrelu=True)
            ...
            l5 = conv_layer(name_scope="convolutional_3", input_tensor=l4, num_kernels=30, kernel_shape=[1, 5], relu=True, lrelu=True)
