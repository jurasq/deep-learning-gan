...
epfiles = ['results/TripleGAN_dna_100_200/'+filename for filename in os.listdir('results/TripleGAN_dna_100_200/') if filename.startswith(seq_dir) and (filename.endswith('0.txt') or filename.endswith('5.txt'))]
